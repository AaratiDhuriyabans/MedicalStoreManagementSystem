...
public class deletemedicine extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					deletemedicine frame = new deletemedicine();
	...
	public deletemedicine() {
	  ...
	  ((JTextField) textField_1).setColumns(10);
		...
		textField_10.setBounds(862, 252, 302, 42);
		...
		JLabel lblNewLabel_11 = new JLabel("       Delete Medicine");
		...
		textField_11.setBounds(862, 314, 302, 40);
